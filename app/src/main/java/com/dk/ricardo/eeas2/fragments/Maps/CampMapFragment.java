 ...
 */
public class CampMapFragment extends Fragment  implements OnMapReadyCallback,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_camp_map, container, false);

        Search=view.findViewById(R.id.butSearch);
        restaurants=view.findViewById(R.id.butRest);
